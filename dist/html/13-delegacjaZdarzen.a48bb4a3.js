...
parent.addEventListener("click", ()=>{
    parentCount++;
    parent.firstChild.textContent = `PARENT klikni\u{119}cie ${parentCount}`;
});
child.addEventListener("click", ()=>{
    childCount++;
    child.firstChild.textContent = `CHILD klikni\u{119}cie ${childCount}`;
});
descendant.addEventListener("click", ()=>{
    descendantCount++;
    descendant.firstChild.textContent = `DESCENDANT klikni\u{119}cie ${descendantCount}`;
});
//section1article2
...
//# sourceMappingURL=13-delegacjaZdarzen.a48bb4a3.js.map
